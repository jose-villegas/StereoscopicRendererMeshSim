...
namespace bases {
    ...
    class ShaderLink {
        ...
        protected:
            ...
            // 0 being the first struct member n the last, check shared_data.glsl to see the
            // structs's members order, uniformLoc is ordered by variable index
            // resize this vector accordly before using
            ...
            virtual void setUniforms(types::ShaderProgram *sh) = 0;
    };
}
